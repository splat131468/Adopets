...
<title>新增信用卡</title>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/views/member/css/creditCard.css">
	<!-- index -->
<link rel="stylesheet"
...
<body>
					...
					<div class="front">
						...
						<svg version="1.1" id="cardfront"
                            ...
                            <g id="Front">
								...
								class="st2 st3 st4">0000 0000 0000 0000</text>
                                <text
								transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname"
								class="st2 st5 st6">Nick</text>
                                <text
			...
			<div class="form-container">
				...
				<div class="field-container">
					<label for="cardnumber">Card Number</label><span id="generatecard">generate
						random</span> <input id="cardnumber" type="text" name="inputNumber" 
						inputmode="numeric">
	...
	<script
		src="<%=request.getContextPath()%>/views/member/js/creditCard.js"></script>
</body>
</html>