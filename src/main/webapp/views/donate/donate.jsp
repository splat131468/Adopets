...
<title>Adopets</title>
    ...
    <!-- js要在jQuery之後才能引進 -->
    <script src="<%=request.getContextPath()%>/resources/background/js/donate.js"></script>
    ...
    <!-- 信用卡 -->
    <script src="<%=request.getContextPath()%>/resources/background/js/donate_creditcard.js"></script>
    <!-- 信用卡 JS-->
    <script
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/background/css/donate.css">



    <link rel="stylesheet" href="https://unpkg.com/purecss@2.0.6/build/pure-min.css">
    <script src="<%=request.getContextPath()%>/resources/background/js/random_verification.js"></script>
    <!--標頭的css-->
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/background/css/homepage.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/background/css/homepage2.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/background/css/homepage3.css">

	<script src="<%=request.getContextPath()%>/resources/background/js/homepage.js"></script>
              ...
              <div class="main-navigation">
                ...
                <div iclass="logo">
                  <a href="#" rel="home" class="site-logo">
                    <img src="./dist/img/Adopets.svg" alt="Home">
                  </a>
                </div>
                      ...
                      <div class="menu-inner menu-level-1">
                        <ul class="menu">
                          ...
                          <li class="menu-item menu-item--expanded">
                            <a href="#">捐贈</a>   
                            <button class="visually-hidden-unless-focused hidden-btn open-sub-menu" role="button"
                              aria-haspopup="true" aria-expanded="false" aria-label="All Pet Care">Open Submenu</button>  
                            <ul class="menu menu-level-2">    
                              <li class="menu-item">
                                <a href="#">捐贈</a>    
                              </li>        
            ...
            <div class="container">
                <div class="row">
                        ...
                        <p>
                            <span style="color: white;">
                                <b>
                                    ...
                                    減少退養的發生；同時也為每一個送養把關，確保領養者能夠和Adopets的浪犬們廝守終身。
                                </b>
                            </span>
                        </p>
                        <p>
                    ...
                    <div class="col-sm-6 col-md-5 offset-md-2 col-lg-6 offset-lg-0">
                        <div class="title_a">
                            <span id="title_1">填寫捐款金額</span>
                            <span id="title_12"><i class="fa-solid fa-caret-right"></i></span>
                            <span id="title_1">填寫捐款人資料及收據</span>
                            <span id="title_12"><i class="fa-solid fa-caret-right"></i></span>
                            <span id="title_1">確認填寫資訊</span>
                            <span id="title_12"><i class="fa-solid fa-caret-right"></i></span>
                            <span id="title_1">捐款資料</span>
                        </div>
                        ...
                        <div id="content-main" class="content-main">
                            ...
                            <div class="price_set">
                                ...
                                <div class="price_set_btn">
                                    <div>
                                        ...
                                        <span class="amount_text">食糧補給 吃飽久久</span>
                                        <input type="hidden" id="amount" name="donateAmo" value="500">
                                    </div>
                                    <div>
                                        <span class="amount">999</span>
                                        <span class="amount_text">跳蚤壁蝨 一錠藥除</span>
                                         <input type="hidden" id="amount" name="donateAmo" value="999">
                                    </div>
                                    <div>
                                        <span class="amount">1500</span>
                                        <span class="amount_text">正向訓練 送養優化</span>
                                         <input type="hidden" id="amount" name="donateAmo" value="1500">
                                    </div>
                                    <div>
                                        <span class="amount">3000</span>
                                        <span class="amount_text">傷病醫療 即刻救助</span>
                                         <input type="hidden" id="amount" name="donateAmo" value="3000">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom_amount">
                                <label for="custom-other-amount"
                                    style="margin-bottom: 20px; margin-right:15px;">自訂金額</label>
                                <input placeholder="請輸入" type="number" name="donateAmo"
                                    id="custom-other-amount" class="custom-other-amount" value="${donVO.donateAmo}"
                            ...
                            <!--------------------------- 查詢貓咪-------------------------------->
                            <div class="find_cat" style="margin-bottom: 20px; margin-right:15px;">
                                <div>
                                    <label for="cat_option" >援助指定貓咪</label>
                                </div>
                                <div>
                                    <p>Adopets平台所有貓咪 / 收容所所有貓咪 / 個別貓咪</p>
                                </div>
                                <div>
                                    <label for="cat_option" style="margin-top: 2%;" >指定單位</label>
                                </div>
                                <div>
                                    <p>Adopets平台 / 收容所 </p>
                                </div>
...
<!--------------------------------------------------------------------------------------------------------------------------------------->
                            ...
                            <div class="btn_content">
                                ...
                                <div class="crm-group">
                                    <fieldset id="profile-group-10">
                                        ...
                                        <div class="content">
                                            <input size="30" maxlength="60" type="text" name="email-5" id="email-5"
                                                class="form-text big required" required >
                                        </div>
                                        ...
                                        <div class="name-2">
                                            ...
                                            <div class="content2">
                                                <input size="30" maxlength="64" type="text" name="first_name"
                                                    id="first_name-5" class="form-text_name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="phone-1">
                                            ...
                                            <div class="content3">
                                                <input size="20" maxlength="32" type="number" name="phone_name"
                                                    class="phone_name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="content5">
                                            <input type="text" name="street_address" class="street_address"
                                                maxlength="96" size="45">
                                        </div>
                                        ...
                                        <div>
                                            <textarea name="" id="donate_message" cols="25" rows="4" placeholder="請輸入..."></textarea>
                                        </div>
                        ...
                        <div id="content-main2">
                            ...
                            <div class="form-container">
                                ...
                                <div class="field-container">
                                    <label for="cardnumber">信用卡號</label><span id="generatecard">generate
                                        random</span>
                                ...
                                <div class="field-container">
                                    <label for="expirationdate">有效月年 (mm/yy)</label>
                                ...
                                <form id="myform" class="pure-form pure-form-stacked">
                                    <fieldset>
                                        ...
                                        <div class="pure-control-group-checked">
                                            <span>
                                                <a class="btn_pure" type="button">上一步</a>
                                            </span>
    ...
    <footer>
        <div class="foot">
            © Copyright 2022, Adopets Sanctuary Taiwan. All rights reserved.
        </div>
    </footer>
