                ...
                <pfdc-header class="header">
                    <header class="header-inner">
                        ...
                        <div class="header-inner-main">
                            <a href="../ADOPETS_Home/petfinder_like/My_home.html" rel="home" class="site-logo">
                                <img src="../ADOPETS_Home/img/Adopets.svg" alt="Home">
                            </a>
                            ...
                            <div class="loadableContent-displayWhenLoaded">
                                <div class="animalSearchHeader-inner">
                                    ...
                                    <div class="animalSearchHeader-inner-main">
                                                        ...
                                                        <pf-focus-manager focus-first-focusable="">
                                                            <button animal-type-select-open-btn=""
                                                                ...
                                                                <span
                                                                    ...
                                                                    共有<span
                                                                        class="animalSearchHeader-inner-fundamentalSelectComplete-field-txt-light">
                                                                        8.6K </span> 隻喵
                                                                </span>
                                                            </button>
                                                        </pf-focus-manager>
                                        ...
                                        <pf-element class="animalSearchHeader-inner-editBtn u-isHidden@minMd"
                                            on-click="ui.activate" data-target="#Fundamental_Search_Modal">
                                            <button
                                                class="animalSearchHeader-inner-fundamentalSelectComplete-field-editBtn"
                                                type="button" aria-label="Open animal type and location filter menu">
                                                <svg role="img">
                                            ...
                                            <div class="u-posRelative">
                                                ...
                                                <pfdc-animal-search-results observe-state="animalSearch.results"
                                                    ...
                                                    <div class="animalSearchBody">
                                                        <div
                                                            class="grid grid_gutter grid_gutterLg@minMd m-grid_stretch u-vr6x">
                                                            <!--1st cat-->
                                                            <div class="grid-col grid-col_1/4@minXl">
                                                                <div class="petCard">
                                                                    <a class="petCard-link" href="#">
                                                                        <!--貓照片-->
                                                                        <div alt="" class="petCard-media">
                                                                            <img class="petCard-media-img"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource"
                                                                                sizes="300px">
                                                                        </div>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                            ...
                                                            <div class="petCard">
                                                                <a class="petCard-link" href="#">
                                                                    ...
                                                                    <div alt="" class="petCard-media">
                                                                        <img class="petCard-media-img"
                                                                            src="./Cats for Adoption Near New York City, NY _ Petfinder_files/cat_pic/cat1.jpeg"
                                                                            sizes="300px">
                                                                    </div>
                                                                    <div class="petCard-body">
                                                                        <div class="petCard-body-details">
                                                            ...
                                                            <div class="petCard">
                                                                <a class="petCard-link" href="#">
                                                                    ...
                                                                    <div alt="" class="petCard-media">
                                                                        <img class="petCard-media-img"
                                                                            src="./Cats for Adoption Near New York City, NY _ Petfinder_files/cat_pic/cat2.jpeg"
                                                                            sizes="300px">
                                                                    </div>
                                                                    <div class="petCard-body">
                                                                        <div class="petCard-body-details">
                                                            ...
                                                            <div class="petCard">
                                                                <a class="petCard-link" href="#">
                                                                    ...
                                                                    <div alt="" class="petCard-media">
                                                                        <img class="petCard-media-img"
                                                                            src="./Cats for Adoption Near New York City, NY _ Petfinder_files/cat_pic/download (1).jpeg"
                                                                            sizes="300px">
                                                                    </div>
                                                                    <div class="petCard-body">
                                                                        <div class="petCard-body-details">
                                                            ...
                                                            <!--可以4個一列-->
                                                            <div class="grid-col">
                                                                <pfdc-ad-container slot-id="SearchResults1"
                                                                    position-target-id="petsearch_top" search-ad=""
                                                                    ad-pool-ids="LEADERBOARD, LARGE_MOBILE_BANNER"
                                                                    style="max-height: 100px">
                                                                    <pfdc-ad slot-id="SearchResults1" non-responsive=""
                                                                        search-ad="" override-ad-id="LEADERBOARD"
                                                                        position-target-id="petsearch_top">
                                                                        <pf-ad id="SearchResults1"
                                                                            targeting="{&quot;distance&quot;:[&quot;100&quot;],&quot;animalType&quot;:[&quot;cats&quot;],&quot;location&quot;:[&quot;us%2Fny%2Fnew-york-city&quot;],&quot;userIsLoggedIn&quot;:true,&quot;savedSearches&quot;:true,&quot;usersCountryCode&quot;:&quot;US&quot;,&quot;usersStateCode&quot;:&quot;NY&quot;,&quot;usersLocationName&quot;:&quot;New York City&quot;}"
                                                                            override-ad-id="LEADERBOARD"
                                                                            position-target-id="petsearch_top"></pf-ad>
                                                                    </pfdc-ad>
                                                                </pfdc-ad-container>
                                                            </div>
                                                            <!--2-1-->
                                                            <div
                                                                ...
                                                                <pfdc-pet-card
                                                                    class="petCard petCard_searchResult s-petCard_hasVideo"
                                                                    set-last-pet-cookie="" offset="4" pet-id="55262754"
                                                                    pet-match-type="good match" id="petId_55262754"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/pongo-55262754/nj/clifton/friends-of-the-clifton-animal-shelter-nj37/"
                                                                        aria-label="Pongo, adoptable Cat, Kitten Male Domestic Medium Hair, 13 miles away, has video, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Pongo, adoptable Cat, Kitten Male Domestic Medium Hair, 13 miles away, has video, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Pongo, adoptable Cat, Kitten Male Domestic Medium Hair, 13 miles away, has video, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(4)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262754/1/?bust=1649609096&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">5th cat</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Pongo,
                                                                                        adoptable Cat, Kitten Male
                                                                                        Domestic Medium Hair, 13 miles
                                                                                        away, has video, Good
                                                                                        Match.</span>
                                                                                    <div class="petCard-body-details-hdg-videoIcon"
                                                                                        title="Has video"></div>
                                                                                </div>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Pongo" pet-id="55262754" pet-index="4"
                                                                        search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Pongo">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="5" pet-id="55262650"
                                                                    pet-match-type="good match" id="petId_55262650"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/rufio-gabi-55262650/ny/new-york/city-critters-inc-ny114/"
                                                                        aria-label="Rufio / Gabi, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Rufio / Gabi, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Rufio / Gabi, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(5)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55262650/1/?bust=1649608546&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">6th cat</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Rufio
                                                                                        / Gabi, adoptable Cat, Kitten
                                                                                        Male Domestic Short Hair, 1 mile
                                                                                        away, Good Match.</span>
                                                                        ...
                                                                        <div class="petCard-status">
                                                                            <div
                                                                                class="petCard-status-flag petCard-status-flag_goodMatch">
                                                                                <span
                                                                                    class="icon m-icon_colorAltS1"><svg
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Rufio / Gabi" pet-id="55262650"
                                                                        pet-index="5" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Rufio / Gabi">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="6" pet-id="55261438"
                                                                    pet-match-type="good match" id="petId_55261438"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/beanie-available-55261438/nj/oakhurst/wag-on-inn-rescue-nj259/"
                                                                        aria-label="BEANIE - Available!, adoptable Cat, Kitten Male Bombay Mix, 31 miles away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="BEANIE - Available!, adoptable Cat, Kitten Male Bombay Mix, 31 miles away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="BEANIE - Available!, adoptable Cat, Kitten Male Bombay Mix, 31 miles away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(6)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55261438/1/?bust=1649624154&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">7th cat</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="BEANIE - Available!" pet-id="55261438"
                                                                        pet-index="6" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite BEANIE - Available!">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="7" pet-id="55258595"
                                                                    pet-match-type="good match" id="petId_55258595"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/jamil-55258595/ct/marion/nile-valley-egyptian-foundation-ct515/"
                                                                        aria-label="Jamil, adoptable Cat, Kitten Male Egyptian Mau &amp; Turkish Angora Mix, 81 miles away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Jamil, adoptable Cat, Kitten Male Egyptian Mau &amp; Turkish Angora Mix, 81 miles away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Jamil, adoptable Cat, Kitten Male Egyptian Mau &amp; Turkish Angora Mix, 81 miles away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(7)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55258595/1/?bust=1649538338&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">8th cat</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Jamil" pet-id="55258595" pet-index="7"
                                                                        search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Jamil">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="8" pet-id="55253886"
                                                                    pet-match-type="good match" id="petId_55253886"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/ryder-55253886/ny/harrison/pet-rescue-ny187/"
                                                                        aria-label="Ryder, adoptable Cat, Young Male Extra-Toes Cat / Hemingway Polydactyl, 22 miles away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Ryder, adoptable Cat, Young Male Extra-Toes Cat / Hemingway Polydactyl, 22 miles away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Ryder, adoptable Cat, Young Male Extra-Toes Cat / Hemingway Polydactyl, 22 miles away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(8)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253886/1/?bust=1649476935&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">3-1</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Ryder,
                                                                                        adoptable Cat, Young Male
                                                                                        Extra-Toes Cat / Hemingway
                                                                                        Polydactyl, 22 miles away, Good
                                                                                        Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Ryder" pet-id="55253886" pet-index="8"
                                                                        search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Ryder">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="9" pet-id="55253359"
                                                                    pet-match-type="good match" id="petId_55253359"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/mulberry-55253359/ny/new-york/city-critters-inc-ny114/"
                                                                        aria-label="Mulberry, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Mulberry, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Mulberry, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(9)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55253359/1/?bust=1649468027&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Mulberry</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Mulberry,
                                                                                        adoptable Cat, Kitten Male
                                                                                        Domestic Short Hair, 1 mile
                                                                                        away, Good Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Mulberry" pet-id="55253359"
                                                                        pet-index="9" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Mulberry">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card
                                                                    class="petCard petCard_searchResult s-petCard_hasVideo"
                                                                    set-last-pet-cookie="" offset="10" pet-id="55252040"
                                                                    pet-match-type="good match" id="petId_55252040"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/raquel-55252040/ny/new-york/harlem-cats-ny1437/"
                                                                        aria-label="Raquel, adoptable Cat, Kitten Male Domestic Short Hair, 6 miles away, has video, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Raquel, adoptable Cat, Kitten Male Domestic Short Hair, 6 miles away, has video, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Raquel, adoptable Cat, Kitten Male Domestic Short Hair, 6 miles away, has video, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(10)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55252040/1/?bust=1649457579&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Raquel</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Raquel,
                                                                                        adoptable Cat, Kitten Male
                                                                                        Domestic Short Hair, 6 miles
                                                                                        away, has video, Good
                                                                                        Match.</span>
                                                                                    <div class="petCard-body-details-hdg-videoIcon"
                                                                                        title="Has video"></div>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Raquel" pet-id="55252040"
                                                                        pet-index="10" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Raquel">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="11" pet-id="55251858"
                                                                    pet-match-type="good match" id="petId_55251858"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/belmont-55251858/ny/brooklyn/little-wanderers-nyc-inc-ny1560/"
                                                                        aria-label="Belmont, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Belmont, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Belmont, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(11)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251858/1/?bust=1649459721&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Belmont</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Belmont,
                                                                                        adoptable Cat, Kitten Male
                                                                                        Domestic Short Hair, 1 mile
                                                                                        away, Good Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Belmont" pet-id="55251858"
                                                                        pet-index="11" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Belmont">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="12" pet-id="55251857"
                                                                    pet-match-type="good match" id="petId_55251857"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/parkchester-55251857/ny/brooklyn/little-wanderers-nyc-inc-ny1560/"
                                                                        aria-label="Parkchester, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Parkchester, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Parkchester, adoptable Cat, Kitten Male Domestic Short Hair, 1 mile away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(12)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55251857/1/?bust=1649459753&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Parkchester</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Parkchester,
                                                                                        adoptable Cat, Kitten Male
                                                                                        Domestic Short Hair, 1 mile
                                                                                        away, Good Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Parkchester" pet-id="55251857"
                                                                        pet-index="12" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Parkchester">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="13" pet-id="55250025"
                                                                    pet-match-type="good match" id="petId_55250025"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/kittens-coming-55250025/nj/clifton/friends-of-the-clifton-animal-shelter-nj37/"
                                                                        aria-label="Kittens Coming, adoptable Cat, Kitten Male Domestic Short Hair, 13 miles away, Good Match.">
                                                                        <div class="petCard-media"></div>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Kittens
                                                                                        Coming</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Kittens
                                                                                        Coming, adoptable Cat, Kitten
                                                                                        Male Domestic Short Hair, 13
                                                                                        miles away, Good Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Kittens Coming" pet-id="55250025"
                                                                        pet-index="13" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Kittens Coming">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card
                                                                    class="petCard petCard_searchResult s-petCard_hasVideo"
                                                                    set-last-pet-cookie="" offset="14" pet-id="55249682"
                                                                    pet-match-type="good match" id="petId_55249682"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/piglet-winnie-55249682/ny/staten-island/strays-hope-for-life-ny1423/"
                                                                        aria-label="Piglet &amp; Winnie, adoptable Cat, Kitten Male Domestic Short Hair, 13 miles away, has video, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Piglet &amp; Winnie, adoptable Cat, Kitten Male Domestic Short Hair, 13 miles away, has video, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Piglet &amp; Winnie, adoptable Cat, Kitten Male Domestic Short Hair, 13 miles away, has video, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(13)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55249682/1/?bust=1649446255&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">Piglet
                                                                                        &amp; Winnie</span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Piglet
                                                                                        &amp; Winnie, adoptable Cat,
                                                                                        Kitten Male Domestic Short Hair,
                                                                                        13 miles away, has video, Good
                                                                                        Match.</span>
                                                                                    <div class="petCard-body-details-hdg-videoIcon"
                                                                                        title="Has video"></div>
                                                                                </div>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Piglet &amp; Winnie" pet-id="55249682"
                                                                        pet-index="14" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Piglet &amp; Winnie">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                            ...
                                                            <div
                                                                ...
                                                                <pfdc-pet-card class="petCard petCard_searchResult "
                                                                    set-last-pet-cookie="" offset="15" pet-id="55243929"
                                                                    pet-match-type="good match" id="petId_55243929"
                                                                    data-test="Search_Results_Pet_Card_List">

                                                                    <a pfdc-pet-card-link="" class="petCard-link"
                                                                        href="https://www.petfinder.com/cat/sampson-55243929/nj/mount-royal/south-jersey-rescue-nj468/"
                                                                        aria-label="Sampson , adoptable Cat, Kitten Male Domestic Short Hair, 89 miles away, Good Match.">

                                                                        <pfdc-lazy-load element="img"
                                                                            alt="Sampson , adoptable Cat, Kitten Male Domestic Short Hair, 89 miles away, Good Match."
                                                                            class="petCard-media"
                                                                            img-class="petCard-media-img"
                                                                            img-animation-class="m-petCard-media-img_reveal"
                                                                            src="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=300"
                                                                            sizes="300px"
                                                                            srcset="
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=600 600w"
                                                                            aria-hidden="true"><img
                                                                                alt="Sampson , adoptable Cat, Kitten Male Domestic Short Hair, 89 miles away, Good Match."
                                                                                class="petCard-media-img"
                                                                                animation-class="m-petCard-media-img_reveal"
                                                                                src="./Cats for Adoption Near New York City, NY _ Petfinder_files/saved_resource(14)"
                                                                                sizes="300px"
                                                                                srcset="https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=300 300w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=450 450w,
                                https://dl5zpyw5k3jeb.cloudfront.net/photos/pets/55243929/1/?bust=1649386961&amp;width=600 600w"
                                                                                aria-hidden="true"></pfdc-lazy-load>
                                                                        <div class="petCard-body">
                                                                            <div class="petCard-body-details">
                                                                                <div class="petCard-body-details-hdg">
                                                                                    <span aria-hidden="true"
                                                                                        data-test="Pet_Card_Pet_Details_List">4-4
                                                                                    </span>
                                                                                    <span
                                                                                        class="u-isVisuallyHidden">Sampson
                                                                                        , adoptable Cat, Kitten Male
                                                                                        Domestic Short Hair, 89 miles
                                                                                        away, Good Match.</span>
                                                                    ...
                                                                    <pfdc-favorite-btn class="petCard-favoriteBtn"
                                                                        pet-name="Sampson " pet-id="55243929"
                                                                        pet-index="15" search-result="">
                                                                        <button
                                                                            class="favoriteBtn favoriteBtn_searchResult"
                                                                            aria-label="Favorite Sampson ">
                                                                            <svg role="img">
                                                                                <use
                                                                                    xlink:href="#icon-favorite_outline">
                                                                                </use>
                                                    ...
                                                    <pfdc-modal id="Share_Pet_Modal"
                                                        class="modal m-modal_bgColorPrimaryS2" role="dialog"
                                                        aria-labelledby="Share_Modal_Header"
                                                        style="display: none; opacity: 1;">
                                                        <div pf-modal-content=""
                                                            class="modal-content m-modal-content_padded"
                                                            style="display: none; opacity: 1;">
                                                            <div class="media-img u-vrTop4x">
                                                                <div
                                                                    class="imgMask imgMask_circleXxl m-imgMask_borderWhite m-imgMask_center m-imgMask_placeholder m-imgMask_transparentPlaceholder">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="vrArray">
                                                                <div class="m-txt_alignCenter">
                                                                    <div id="Share_Modal_Header"
                                                                        ...
                                                                        Share 8594 Cats near New York City, NY
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="m-txt_alignCenter">
                                                                    <ul class="hrArray m-hrArray_2x u-vr4x">
                                                                        <li name="facebook">
                                                                            <a href="http://www.facebook.com/sharer/sharer.php?u=https://www.petfinder.com/search/cats-for-adoption/us/ny/new-york-city/?sort%5B0%5D=best_match"
                                                                                target="_blank"
                                                                                class="icon icon_socialCircleWhite_lg m-icon_colorWhite"
                                                                                title="Share to Facebook"
                                                                                aria-label="Share 8594 Cats near New York City, NY to Facebook">
                                                                                <svg role="img" focusable="false">
                                                                        ...
                                                                        <li name="twitter">
                                                                            <a href="http://www.twitter.com/intent/tweet?text=&amp;url=https%3A%2F%2Fwww.petfinder.com%2Fsearch%2Fcats-for-adoption%2Fus%2Fny%2Fnew-york-city%2F%3Fsort%255B0%255D%3Dbest_match"
                                                                                class="icon icon_socialCircleWhite_lg m-icon_colorWhite"
                                                                                title="Share to Twitter"
                                                                                aria-label="Share 8594 Cats near New York City, NY to Twitter">
                                                                                <svg role="img" focusable="false">
                                                                        ...
                                                                        <li name="pinterest">
                                                                            <a href="http://www.pinterest.com/pin/create/button/?url=https://www.petfinder.com/search/cats-for-adoption/us/ny/new-york-city/?sort%5B0%5D=best_match&amp;description=https%3A%2F%2Fwww.petfinder.com%2Fsearch%2Fcats-for-adoption%2Fus%2Fny%2Fnew-york-city%2F%3Fsort%255B0%255D%3Dbest_match"
                                                                                target="_blank"
                                                                                class="icon icon_socialCircleWhite_lg m-icon_colorWhite"
                                                                                title="Share to Pinterest"
                                                                                aria-label="Share 8594 Cats near New York City, NY to Pinterest">
                                                                                <svg role="img" focusable="false">
                                                                        ...
                                                                        <li name="email">
                                                                            <a href="mailto:?subject=8594%20Cats%20near%20New%20York%20City%2C%20NY&amp;body=https%3A%2F%2Fwww.petfinder.com%2Fsearch%2Fcats-for-adoption%2Fus%2Fny%2Fnew-york-city%2F%3Fsort%255B0%255D%3Dbest_match"
                                                                                class="icon icon_socialCircleWhite_lg m-icon_colorWhite"
                                                                                title="Share via email"
                                                                                aria-label="Share 8594 Cats near New York City, NY via email">
                                                                                <svg role="img" focusable="false">
                                                                        ...
                                                                        <li name="linkShare">
                                                                            <pfdc-clipboard command="copy"
                                                                                text="https://www.petfinder.com/search/cats-for-adoption/us/ny/new-york-city/?sort%5B0%5D=best_match">
                                                                                <a id="Petcard_8594 Cats near New York City, NY_Copy_Link"
                                                                                    href="https://www.petfinder.com/search/cats-for-adoption/us/ny/new-york-city/?sort%5B0%5D=best_match"
                                                                                    class="icon icon_socialCircleWhite_lg m-icon_colorWhite u-noChildPointerEvents"
                                                                                    title="Copy petfinder url to clipboard"
                                                                                    aria-label="Copy 8594 Cats near New York City, NY search url to your clipboard"
                                                                                    tooltip=""
                                                        ...
                                                        <pf-element class="fullscreenCarousel-close"
                                                            on-click="ui.deactivate" data-target="#Share_Pet_Modal">
                                                            <button class="modal-closeBtn modal-closeBtn_colorWhite"
                                                                type="button" aria-label="Close this dialog">Close this
                                                                dialog</button>
                                                        </pf-element>
                                                    </pfdc-modal>
                                                        ...
                                                        <div class="grid grid_gutterLg">
                                                            ...
                                                            <div class="grid-col grid-col_3/4@minMd grid-col_3/5@minXl">
                                                                <pfdc-page-controls>
                                                                    <div class="grid grid_gutterLg">
                                                                        <div
                                                                            class="grid-col grid-col_1/3 u-isHidden@maxMd">

                                                                        </div>
                                                                        <!--分頁標籤分頁標籤分頁標籤分頁標籤分頁標籤分頁標籤分頁標籤分頁標籤分頁標籤-->
                                                                        <div
                                                                            class="grid-col grid-col_1/2 grid-col_1/3@minMd">

                                                                            <pfdc-generic-select id="page-select"
                                                                                ...
                                                                                aria-label="Select page, PAGE 1/215"
                                                                                input-aria-label="Select page, PAGE 1/215"
                                                                                ...
                                                                                <div
                                                                                    class="animalSearchSelect animalSearchSelect_shadowed animalSearchSelect_checkmarks ">

                                                                                    <div
                                                                                        class="animalSearchSelect-customSelect">
                                                                                        <div class="animalSearchSelect-customSelect-btn">
                                                                                            <div
                                                                                                class="split m-split_fullHeight">
                                                                                                <div class="txt">
                                                                                                    PAGE 1/x
                                                                                                </div>
                                                                                            </div>
                                                                        ...
                                                                        <!--下一頁下一頁下一頁下一頁下一頁下一頁下一頁下一頁下一頁下一頁下一頁下一頁-->
                                                                        <div
                                                                            class="grid-col grid-col_1/2 grid-col_1/3@minMd">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                type="button"
                                                                                pf-mix-click="$closest.goToNextPage();pageChangeScrollTarget.scrollIntoView(true);pageChangeFocusTarget.focus();trackingBridge.ensighten(&#39;Consumer070&#39;);">
            ...
            <footer class="site-footer" role="contentinfo">
                <div class="footer">
                    ...
                    <div class="footer-inner">
                        <a href="../ADOPETS_Home/petfinder_like/My_home.html" class="footer-inner-logo">
