        ...
        $(function () {
          ...
          $(document).on("click", ".pg", function () {
            ...
            $.ajax({
              ...
              type: "POST",
              success: function () {
                $("#partial").load("/Adopets/views/ecommerce/Pet_Supplement.jsp #partial")
              }
                        ...
                        <div id="mos" class="product__item mos">
                          <div class="product__item__pic ">
                            ...
                            <ul class="product__item__pic__hover">
                              ...
                              <li><a
                                  href="${pageContext.request.contextPath}/cartAction?action=getDetail&spuID=${skuPage.spuVO.spuID}"><i
