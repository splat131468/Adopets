...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/nice-select.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/views/ecommerce/css_ecommerce/style.css" type="text/css">
    <!-- index -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div
                        style="border: 1px; border-color: black; border-top-style: solid; border-bottom-style: solid; ">
                        <form action="#">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
<%--                        應該是多對一--%>
                        <c:forEach items="${mainPage}" var="sku">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic ">
                                    <!-- 路徑 -->
                                    <img src="${pageContext.request.contextPath}/comAction?action=getPic&skuID=${sku.skuID}" width="150px" height="150px" />
                                ...
                                <div class="product__item__text">
                                    ...
                                    <h6><a href="#">${sku.spuVO.spuName}</a></h6>

                                    <p style="margin-bottom:5px;">${sku.specAttr}</p>
                                  <h5>${sku.skuPrice}</h5>
                                </div>
                            </div>
                        </div>
