...
private AdminDAO_interface dao;
	...
	public AdminVO addAdmin(String account,String password,String name, 
			byte[] personImg,boolean accStatus) {
	...
	public AdminVO updateManager(Integer adminID,String account,String password,String name, 
			byte[] personImg,boolean accStatus) {
	...
	public AdminVO updateEmployee(Integer adminID,String account,String password,String name, 
			byte[] personImg) {
