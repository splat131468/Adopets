...
/**
 * Servlet implementation class UploadAdmImg
 */
@WebServlet("/UploadAdmImg")
public class UploadAdmImg extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			ResultSet rs = stmt.executeQuery(
				"SELECT personImg FROM ADMIN where adminID ="+adminID);
